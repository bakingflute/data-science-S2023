...
-   (Write your observations here!)
    -   Price generally increases with carat; the trend is not 'clean,' as there is no single curve in the relationship
...
-   (Write your observations here!)
    -   The plot reveals that higher-quality cuts (e.g., Ideal) tend to have smaller carat sizes but higher prices per carat compared to lower-quality cuts (e.g., Fair). This suggests cut quality significantly impacts price beyond just carat weight. There is also noticeable overlap between cut categories in the mid-range carat values.
