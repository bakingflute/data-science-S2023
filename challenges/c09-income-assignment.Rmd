...
filename_income <- NA_character_"./data/ACSST5Y2018.S1903-Data.csv"
...
-   Document your observations here.
    -   The graph is a bit harder to read as the lines and words are really stretched out to fit everything.
    -   Nantucket has a very wide disparity of incomes for five person families. I wonder outside of the data, what is going on for the range to be that bad.
    -   It is also kind of scary that it's not six person families making the most everywhere, as they most likely need the most money to support everyone; the same thing applies with two person families, but instead they make usally make the lowest or are on the lower ends.
-   Can you confidently distinguish between household incomes in Suffolk county? Why or why not?
    -   I feel that I can barely find the difference between Suffolk county as it seems the income for everyone is super clsoe together, with a small increase per addtiionall family.
